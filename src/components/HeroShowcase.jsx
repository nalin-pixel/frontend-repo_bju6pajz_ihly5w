  ...
  return (
    <section className="relative w-full h-[58vh] md:h-[64vh] lg:h-[68vh] xl:h-[72vh] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Spline scene="https://prod.spline.design/2hQy4oY0wI-FREE-PLACEHOLDER/scene.splinecode" style={{ width: '100%', height: '100%' }} />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 h-full flex items-center">
        <div className="max-w-2xl">
          ...
          <h1 className="text-cream-sand text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <button className="rounded-full bg-white/10 border border-white/15 text-cream-sand px-6 py-3 font-semibold hover:bg-white/15 transition">Explore Suites</button>
          </div>
        </div>
      </div>
    </section>
